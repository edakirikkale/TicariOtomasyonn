...
namespace Ticari_Otomasyon.DboTicariOtomasyonDataSetTableAdapters {
    ...
    public partial class TBL_FIRMALARTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [TBL_FIRMALAR] WHERE (([ID] = @Original_ID) AND ((@IsNull_AD = 1 AND " +
                "[AD] IS NULL) OR ([AD] = @Original_AD)) AND ((@IsNull_YETKILISTATU = 1 AND [YETK" +
                "ILISTATU] IS NULL) OR ([YETKILISTATU] = @Original_YETKILISTATU)) AND ((@IsNull_Y" +
                "ETKILIADSOYAD = 1 AND [YETKILIADSOYAD] IS NULL) OR ([YETKILIADSOYAD] = @Original" +
                "_YETKILIADSOYAD)) AND ((@IsNull_YETKILITC = 1 AND [YETKILITC] IS NULL) OR ([YETK" +
                "ILITC] = @Original_YETKILITC)) AND ((@IsNull_SEKTOR = 1 AND [SEKTOR] IS NULL) OR" +
                " ([SEKTOR] = @Original_SEKTOR)) AND ((@IsNull_TELEFON1 = 1 AND [TELEFON1] IS NUL" +
                ...
                "= @Original_ILCE)) AND ((@IsNull_VERGIDAIRE = 1 AND [VERGIDAIRE] IS NULL) OR ([V" +
                "ERGIDAIRE] = @Original_VERGIDAIRE)) AND ((@IsNull_ADRES = 1 AND [ADRES] IS NULL)" +
                " OR ([ADRES] = @Original_ADRES)) AND ((@IsNull_OZELKOD1 = 1 AND [OZELKOD1] IS NU" +
                "LL) OR ([OZELKOD1] = @Original_OZELKOD1)) AND ((@IsNull_OZELKOD2 = 1 AND [OZELKO" +
                "D2] IS NULL) OR ([OZELKOD2] = @Original_OZELKOD2)) AND ((@IsNull_OZELKOD3 = 1 AN" +
                "D [OZELKOD3] IS NULL) OR ([OZELKOD3] = @Original_OZELKOD3)))";
...
SELECT ID, AD, YETKILISTATU, YETKILIADSOYAD, YETKILITC, SEKTOR, TELEFON1, TELEFON2, TELEFON3, MAIL, FAX, IL, ILCE, VERGIDAIRE, ADRES, OZELKOD1, OZELKOD2, OZELKOD3 FROM TBL_FIRMALAR WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [TBL_FIRMALAR] SET [AD] = @AD, [YETKILISTATU] = @YETKILISTATU, [YETKILIADS" +
                "OYAD] = @YETKILIADSOYAD, [YETKILITC] = @YETKILITC, [SEKTOR] = @SEKTOR, [TELEFON1" +
                "] = @TELEFON1, [TELEFON2] = @TELEFON2, [TELEFON3] = @TELEFON3, [MAIL] = @MAIL, [" +
                "FAX] = @FAX, [IL] = @IL, [ILCE] = @ILCE, [VERGIDAIRE] = @VERGIDAIRE, [ADRES] = @" +
                "ADRES, [OZELKOD1] = @OZELKOD1, [OZELKOD2] = @OZELKOD2, [OZELKOD3] = @OZELKOD3 WH" +
                "ERE (([ID] = @Original_ID) AND ((@IsNull_AD = 1 AND [AD] IS NULL) OR ([AD] = @Or" +
                "iginal_AD)) AND ((@IsNull_YETKILISTATU = 1 AND [YETKILISTATU] IS NULL) OR ([YETK" +
                "ILISTATU] = @Original_YETKILISTATU)) AND ((@IsNull_YETKILIADSOYAD = 1 AND [YETKI" +
                "LIADSOYAD] IS NULL) OR ([YETKILIADSOYAD] = @Original_YETKILIADSOYAD)) AND ((@IsN" +
                "ull_YETKILITC = 1 AND [YETKILITC] IS NULL) OR ([YETKILITC] = @Original_YETKILITC" +
                ")) AND ((@IsNull_SEKTOR = 1 AND [SEKTOR] IS NULL) OR ([SEKTOR] = @Original_SEKTO" +
                "R)) AND ((@IsNull_TELEFON1 = 1 AND [TELEFON1] IS NULL) OR ([TELEFON1] = @Origina" +
                "l_TELEFON1)) AND ((@IsNull_TELEFON2 = 1 AND [TELEFON2] IS NULL) OR ([TELEFON2] =" +
                ...
                "YETKILITC, SEKTOR, TELEFON1, TELEFON2, TELEFON3, MAIL, FAX, IL, ILCE, VERGIDAIRE" +
